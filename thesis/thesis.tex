...
% procedures
\newcommand{\procGen}{$GEN()$}
\newcommand{\procGenPartSig}{$GEN\_PT\_SIG(\varMsg \opSeperate \varKey \opSeperate \varRand \opSeperate \varGkSt \opSeperate \varGrSt)$}
\newcommand{\procVerfPartSig}{$VRF\_PT\_SIG(\varMsg \opSeperate \varKey \opSeperate \varRand \opSeperate \varGkSt \opSeperate \varGrSt \opSeperate \varSigPart)$}
\newcommand{\procFinSig}{$FIN\_SIG(\varSigPart \opSeperate \varSigPartSt \opSeperate \varGk \opSeperate \varGkSt \opSeperate \varGr \opSeperate \varGrSt)$}
\newcommand{\procAptSig}{$APT\_PT\_SIG(\varSigPart \opSeperate \varWit)$}
\newcommand{\procExtWit}{$EXT\_WIT(\varSigFin \opSeperate \varSigPart \opSeperate \varSigPartAptSt)$}
\newcommand{\procVrfApt}{$VRF\_APT\_SIG(\varMsg \opSeperate \varKey \opSeperate \varRand \opSeperate \varGkSt \opSeperate \varGrSt \opSeperate \varGWit \opSeperate \varSigPartAptSt)$}
