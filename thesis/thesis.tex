...
\newcommand{\funGenH}[1]{g^{#1}}
\newcommand{\funList}[1]{l(#1)}

% variables
\newcommand{\varTx}{tx}
\newcommand{\varEx}{\mathcal{E}}
\newcommand{\varKernel}{\mathcal{K}}
\newcommand{\varG}{g}
\newcommand{\varSupply}{s}
\newcommand{\varH}{h}
\newcommand{\varC}{C}
\newcommand{\varCinp}{C_{inp}}
\newcommand{\varCout}{C_{out}}
\newcommand{\varV}{v}
\newcommand{\varM}{m}
\newcommand{\varK}{k}
\newcommand{\varKSt}{k'}
\newcommand{\varR}{r}
\newcommand{\varRSt}{r'}
\newcommand{\varGk}{\funGen{\varK}}
\newcommand{\varGkSt}{\funGen{\varKSt}}
\newcommand{\varGr}{\funGen{\varR}}
\newcommand{\varGrSt}{\funGen{\varRSt}}
\newcommand{\varSigPart}{sig\_prt}
\newcommand{\varSigPartSt}{sig\_prt'}
\newcommand{\varE}{e}
\newcommand{\varGSigPart}{\funGen{\varSigPart}}
\newcommand{\varSigPartApt}{sig\_part\_apt}
\newcommand{\varSigPartAptSt}{sig\_part\_apt'}
\newcommand{\varGSigPartAptSt}{\funGen{\varSigPartAptSt}}
\newcommand{\varX}{x}
\newcommand{\varGx}{\funGen{\varX}}
\newcommand{\varSigFin}{sig\_final}
...
\newcommand{\procGenPartSig}{$GEN\_PT\_SIG(\varM, \varK, \varR, \varGkSt, \varGrSt)$}
\newcommand{\procVerfPartSig}{$VRF\_PT\_SIG(\varM, \varK, \varR, \varGkSt, \varGrSt, \varSigPart)$}
\newcommand{\procFinSig}{$FIN\_SIG(\varSigPart, \varSigPartSt, \varGk, \varGkSt, \varGr, \varGrSt)$}
\newcommand{\procAptSig}{$APT\_PT\_SIG(\varSigPart, \varX)$}
\newcommand{\procExtWit}{$EXT\_WIT(\varSigFin, \varSigPart, \varSigPartAptSt)$}
\newcommand{\procVrfApt}{$VRF\_APT\_SIG(\varM, \varK, \varR, \varGkSt, \varGrSt, \varGx, \varSigPartAptSt)$}
