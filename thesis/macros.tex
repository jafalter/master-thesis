...
\newcommand{\varSigPartAdv}{\varSignature_{\styleVariable{prt} \opSeperate \cnstAdversary}}
...
\newcommand{\procSetupPartSigId}{\styleFunction{genPt}}
...
\newcommand{\procSetupAptId}{\styleFunction{genApt}}
\newcommand{\procSetupApt}[1]{\procSetupAptId(#1)}
\newcommand{\procGenPtAptSigId}{\styleFunction{genPtPreSig}}
...
\newcommand{\procFinAptSig}[5]{ \procFinAptSigId(#1 \opSeperate #2 \opSeperate #3 \opSeperate #4 \opSeperate #5) }
...
\newcommand{\procSignOracle}[3]{ \procSignOracleId_(#1, #2, #3) }
\newcommand{\procFinOracleId}{ \cnstOracle_{f} }
\newcommand{\procFinOracle}[2]{ \procFinOracleId{#1}{#2} }