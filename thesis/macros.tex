...
\newcommand{\procCreateOutputId}{ \styleFunction{createOutput} }
\newcommand{\procCreateOutput}[3]{\procCreateOutputId<(#1 \opSeperate #2 \opSeperate #3), (#1)>}
\newcommand{\procSpendOutputId}{ \styleFunction{spendOutput} }
\newcommand{\procSpendOutput}[3]{\procSpendOutputId<(#1 \opSeperate #2 \opSeperate #3), (#1)>}
