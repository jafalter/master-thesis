...
\newcommand{\procGenPartSig}[5]{ \procGenPartSigId_{#2 \opSeperate #3 \opSeperate #4 \opSeperate #5}(#1) }
...
\newcommand{\procVerfPartSig}[6]{ \procVerfPartSigId_{#2 \opSeperate #3 \opSeperate #4 \opSeperate #5}(#1 \opSeperate #6) }
