...
How much time exactly should be left for the function to return 1 is implementation specific, fur further discussion we again like to refer to \todo[inline]{timeout paper}
