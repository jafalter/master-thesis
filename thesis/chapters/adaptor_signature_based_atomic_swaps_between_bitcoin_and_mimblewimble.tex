...
\begin{figure}
    \begin{center}
        ...
        \begin{varwidth}{\textwidth}
            ...
            \t \pcif \procVerfProof{\varProofs[\varIterator]}{\varCoinOut} \opEqNoQ 0 \\
            \t \t \pcreturn 0 \\
...
\subsection{Extended Mimblewimble Transation Scheme}

\begin{figure}
    \begin{center}
        \fbox{
        \begin{varwidth}{\textwidth}
            \procedure[linenumbering]{$\procDSendCoins{\funArray{\varCoinInp}}{\funArray{\varBlindingFactorAlice}}{\varFundValue}{\varValue}{\funArray{\varBlindingFactorBob}}$}{
                \pcreturn 1
            } \\
            \procedure[linenumbering]{$\procDRecvCoins{\varPreTx}{\varFundValue}$} {
                ...
                \pcif \procVerfProof{\varProofs[0]}{\varOutputs[0]} \opEqNoQ 0 \< \< \pcif \procVerfProof{\varProofs[0]}{\varOutputs[0]} \opEqNoQ 0 \\
                ...
                \varSecKeyBob \opAssign \funStar{\varBlindingFactorBob} \< \< \\
                \varSigContext \opFunResult \procSetupCtx{\varSigContext}{\funGen{\varSecKeyBob}}{\funGen{\varNonceBob}} \< \< \\
                \< \sendmessageright*{\varCoinShared, \varSigContext} \< \\
                ...
                \< \< \varCoinShared \opAssign \varCoinShared \opAddPoint \funGen{\varSecKeyCarol} \\
                \< \< \varSigContext \opFunResult \procSetupCtx{\varSigContext}{\funGen{\varSecKeyCarol}}{\funGen{\varNonceCarol}} \\
                \< \sendmessageleft*{\varCoinShared, \varSigContext} \\
                \varPreTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs \opConc \varCoinShared}{\varProofs}{\varSigContext}{\varCommits}{} \\
                \pcreturn \varPreTx
            }
        \end{varwidth}
        }
