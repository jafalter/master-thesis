...
\begin{definition}[Adapted Extended Mimblewimble Transaction Scheme]
    ...
    \begin{itemize}
        ...
        However, as in the case we will describe later in \ref{sec:atomic-swap} one of the two senders is also the receiver, we allowed ourselfs to model this protocol as being between only two parties.
    \end{itemize}
\end{definition}
...
\begin{definition}[Adapted Transaction Scheme Correctness]
    ...
    \[
        ...
        \begin{array}{l}
            ...
            \varTx \opFunResult \procDAptFinTx{\varPreTx}{\varSecKeyAlice}{\varNonceAlice}{\varSecKeyCarol}{\varNonceCarol}{\varSigBob}
        \end{array}
        \right]=1.
    \]
\end{definition}
...
\begin{center}
    ...
    \begin{varwidth}{\textwidth}
        ...
        (\varPreTx, \varSecKey, \varNonce) \opFunResult \procSendCoins{\funArray{\varCoinInp}}{\funArray{\varBlindingFactor}}{\varFundValue_b}{\varValue_b} \\
        \funStar{\varPreTx} \opFunResult \procRecvCoins{\varPreTx}{\varFundValue_b} \\
        \pcreturn \procFinTx{\funStar{\varPreTx}}{\varSecKey}{\varNonce}{\cnstFalsum}
        }
    \end{varwidth}
    }
\end{center}
...
\begin{figure}
    \begin{center}
        ...
        \begin{varwidth}{\textwidth}
            ...
            \varPreTx \opFunResult \procCreatePreTx{\varMsg}{\funArray{\varCoinInp}}{\funArray{\varCoinOutAlice}}{\funArray{\varProofAlice}}{\varSigContext}{\funArray{\funGen{\varSecKeyAlice}}}{\cnstEmptySet}{\cnstFalsum} \\
...
\begin{landscape}
    \begin{figure}
            ...
            \< \varPreTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs \opConc \funStarAlt{\varCoinShared}}{\varProofs \opConc \varProofBobCarol}{\funStarAlt{\varSigContext}}{\varCommits \opConc \varPubKeyBobCarol}{\varSigBobCarol}{\cnstFalsum} \< \\
...
\begin{landscape}
    \begin{figure}
        \fbox{
        \procedure[linenumbering]{$\procDFinTx{\varPreTx}{\varSecKeyAlice}{\varNonceAlice}{\varSecKeyCarol}{\varNonceCarol}{\varTime}$} {
        Alice \< \< Carol \\
        (\varMsg, \varInputs, \varOutputs, \varProofs, \varSigContext, \varCommits, \varSigBob) \opFunResult \varPreTx \< \< (\varMsg, \varInputs, \varOutputs, \varProofs, \varSigContext, \varCommits, \varSigBob) \opFunResult \varPreTx \\
        ...
        \varTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs}{\varProofs}{\varSigContext}{\varCommits}{\varSigFin}{\cnstFalsum} \< \< \varTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs}{\varProofs}{\varSigContext}{\varCommits}{\varSigFin}{\varTime} \\
...
\begin{figure}
    \begin{center}
        ...
        \begin{varwidth}{\textwidth}
            ...
            \varPreTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs \opConc \varCoinOutBob}{\varProofs \opConc \varProofBob}{\varSigContext}{\varCommits \opConc \funGen{\varNonceBob}}{\varSigAptBob}{\cnstFalsum} \\
...
\begin{figure}
        \fbox{
        \procedure[linenumbering]{$\procDAptFinTx{\varPreTx}{\varSecKeyAlice}{\varNonceAlice}{\varSecKeyCarol}{\varNonceCarol}{\varSigBob}$} {
        Alice \< \< Bob \\
...
\begin{landscape}
    \begin{figure}
        \fbox{
        \procedure[linenumbering]{$\procSetupSwap{\varSecParam}{\varCoinInp}{\varAmountMW}{\varTimeMW}{\varUTXO}{\varAmountBtc
        }{\varTimeBTC}$} {
        Alice \< \< Bob \\
        ...
        \< \sendmessageright*{\varPubKeyAlice} \\
        \< \< \procLockAddr{\varPubKeyAlice}{\varStatement}{\varPubKeyBob}{\varTimeBTC} \\
        \< \< \varUTXO_{lock} \opFunResult \procCreateUTXO{\varAmountBtc}{\varScriptPubKey} \\
        \< \< \varUTXO_{B} \opFunResult \procCreateUTXO{\varAmount - \varAmountBtc}{\varPubKeyBob} \\
        \< \< \varBtcTx \opFunResult \procBuildTransaction{\funArray{\varUTXO}}{\funArray{\varUTXO_{lock}}}{1}{\cnstEmptySet} \\
        \< \< \procPublishBtc{\funArray{\varBtcTx}} \\
        \< \sendmessageleft*{\varStatement, \varPubKeyBob} \\
        \pcif \procVerifyLock{\varPubKeyAlice}{\varPubKeyBob}{\varStatement}{\varAmountBtc}{\cnstEmptySet} \opEqNoQ 0 \\
        \t \pcreturn 0 \\
        (\varPreTx, (\varSecKeyAlice, \varNonceAlice)) \opFunResult \\ \procSendCoins{\funArray{\varCoinInp}}{\funArray{\varBlindingFactorAlice}}{\varAmountMW}{\varValue} \\
        \< \sendmessageright*{\varPreTx} \\
        \< \langle (\funStar{\varPreTx}, \funStar{\varBlindingFactorAlice}), (\funStar{\varPreTx}, \funStar{\varBlindingFactorBob}) \rangle \\ \<  \opFunResult \procDRecvCoins{\varPreTx}{\varPreTx}  \\
        \varTx \opFunResult \procFinTx{\funStar{\varPreTx}}{\varSecKeyAlice}{\varNonceAlice}{\cnstFalsum} \\
        \< \varPreTx_2 \\ \< \opFunResult \procDSendCoins{\funArray{\varCoinShared}}{\funArray{\funStar{\varBlindingFactorAlice}}}{\varAmountMW}{\varAmountMW}{\funArray{\funStar{\varBlindingFactorBob}}} \\
        \funStar{\varPreTx_2} \opFunResult \procRecvCoins{\varPreTx_2}{\varAmountMW} \\
        \varTx_2 \opFunResult \procDFinTx{\funStar{\varPreTx_2}}{\varSecKeyAlice}{\varNonceAlice}{\varSecKeyBob}{\varNonceBob}{\varTimeMW} \\
...
\begin{landscape}
    \begin{figure}
        ...
        Alice \< \< Bob \\
        \< \langle (\varPreTx, (\varSecKeyAlice, \varNonceAlice), (\varPreTx, (\varSecKeyBob, \varNonceBob))) \rangle \\ \< \opFunResult \procDSendCoins{\funArray{\varCoinShared}}{\funArray{\funStar{\varBlindingFactorAlice}}}{\varAmountMW}{\varAmountMW}{\funArray{\funStar{\varBlindingFactorBob}}} \\
        ...
        \< \langle \cnstEmptySet, \varTx \rangle \opFunResult \procDAptFinTx{\funStar{\varPreTx}}{\varSecKeyAlice}{\varSecKeyBob}{\varSecKeyBob}{\varNonceBob}{\varSigBob} \\
        \< \< \procPublishMW{\varTx} \\
        \< \sendmessageleft*{\varTx} \\
        (\cdot,\cdot,\cdot,\cdot,\cdot,\cdot,\varSigFin) \opFunResult \varPreTx \< \< \\
        ...
        \funStar{\varUTXO} \opFunResult \procSpendUTXO{\varUTXO}{\varSecKey_{BTC}} \\
        \varBtcTx \opFunResult \procBuildTransaction{\funArray{\funStar{\varUTXO}}}{\funArray{\varUTXO_{A}}}{1}{\cnstEmptySet} \\
        \procPublishBtc{\varBtcTx}
        }
        }
