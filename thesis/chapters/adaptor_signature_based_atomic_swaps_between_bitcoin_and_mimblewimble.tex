...
\begin{definition}[Adapted Extended Mimblewimble Transaction Scheme]
    ...
    \begin{itemize}
        ...
        \item $((\varTx, \varWit), \varTx) \opFunResult \procDAptFinTx{\varPreTx}{\varSecKeyAlice}{\varNonceAlice}{\varSecKeyCarol}{\varNonceCarol}{\varSigBob}$: The adapted variant of the finalize transaction algorithm is a distributed protocol between the sender
...
\begin{landscape}
    \begin{figure}
        ...
        \varTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs}{\varProofs}{\varSigContext}{\varCommits}{\varSigFin}{\cnstFalsum} \< \< \varTx \opFunResult \procCreatePreTx{\varMsg}{\varInputs}{\varOutputs}{\varProofs}{\varSigContext}{\varCommits}{\varSigFin}{\cnstFalsum} \\
...
\begin{landscape}
    \begin{figure}
        ...
        \varTx_2 \opFunResult \procDFinTx{\funStar{\varPreTx_2}}{\varSecKeyAlice}{\varNonceAlice}{\varSecKeyBob}{\varNonceBob} \\
