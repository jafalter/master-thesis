...
\begin{itemize}
    \item $(\varAddress, \varUTXO) \opFunResult \procLockAddr{\varPubKeyAlice}{\varStatement}{\varPubKeyBob}{\varTime}$:
...
We assume Alice owns Mimblewimble coins $\varCoinOutAlice$ and Bob Bitcoin locked in some UTXO
$\varUTXO$ belonging to him.
