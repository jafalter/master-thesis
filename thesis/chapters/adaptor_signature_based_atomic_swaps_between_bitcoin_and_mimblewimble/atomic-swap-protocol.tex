...
\begin{landscape}
    ...
    \begin{figure}
        \fbox{
        \procedure[linenumbering]{$\procSetupSwap{\varSwpState}{\funArray{\varSpendableCoin}}{\varValueMw}{\funArray{\varUTXO}}{\funArray{\varSecKey_{btc}}}{\varValueBtc}$} {
        Alice \< \< \< \< Bob \\
        ...
        \t \pcreturn \cnstFalsum \< \< \< \< \\
        (\varMwFundTx, \funStar{\varSpendableCoinAlice},\funStar{\varPtSpendableCoinAlice}) \< \< \< \< (\varMwFundTx, \funStar{\varPtSpendableCoinBob}) \\
        ...
        (\varMwRefundTx, \funStarAlt{\varSpendableCoinAlice}) \< \< \< \< \varMwRefundTx \\
