...
Furthermore we require a Rangeproof system $\varProofSystem$ as defined in~\cref{sec:pre:rangeproof} and a two-party signature scheme $\varSigSchemeMP$ as defined in~\cref{def:sig:two-party-sig}.
...
Figure~\cref{fig:ext-mim-tx-spend} shows an instantiation of the $\procDSendCoinsId$ function of the Extended Mimblewimble Transaction Scheme.
...
Figure~\cref{fig:ext-mim-tx-recv} shows an instantiation of the $\procDSendCoinsId$ function of the Extended Mimblewimble Transaction Scheme.
