...
\begin{figure}
    \begin{center}
        ...
        \begin{varwidth}{\textwidth}
            ...
            \pcreturn (\opForAll \varI \opNotEq \varJ : \varInputs[\varI] \opNotEq \varInputs[\varJ] \opAnd \varOutputs[\varI] \opNotEq \varOutputs[\varJ]) \text{ and } \\
...
\begin{landscape}
    ...
    \begin{figure}
        \fbox{
        \procedure[linenumbering]{$\procDSendCoins{\funArray{\varPtSpendableCoinAlice}}{\funArray{\varPtSpendableCoinCarol}}{\varFundValue}{\varTime}$}{
        Alice \< \< Carol \\
