...
\subsection{A note on rogue-key attacks:}\label{subsec:atom:rogue}

In~\cref{sec:sig:definitions}, we mentioned that we need to take special care in the key generation phase in a Two-Party Signature Scheme.
...
\begin{figure}
    \begin{center}
        ...
        \begin{varwidth}{\textwidth}
            ...
            \< \sendmessageright*[2cm]{\varPreTx, \varCoinShared} \< \\
            \< \< \< \< \color{blue} \pcif \procZkf{\cnstRelation_2}{\varCoinShared} \opEqNoQ 0 \\
            \< \< \< \< \color{blue} \t \pcreturn \cnstFalsum \\
            \< \< \< \< \cdots \\
            \< \< \< \< \color{blue} \procZkf{\cnstRelation_1}{(\varSecKeyCarol, \funGen{\varSecKeyCarol})} \\
            \< \sendmessageleft*[2cm]{\funStarAlt{\varPreTx}, \funGen{\varSecKeyCarol}} \< \\
