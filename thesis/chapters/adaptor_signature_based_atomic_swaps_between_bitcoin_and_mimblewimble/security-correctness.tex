...
\begin{varwidth}{\textwidth}
    ...
    Alice \< \< Carol \\
    \procZkf{\cnstRelation_2*}{\funArray{(\varSpendableCoin.\varCommitment, (\varSpendableCoin.\varBlindingFactor, \varSpendableCoin\varValue))}} \\
    ...
    \procZkf{\cnstRelation_2}{(\varNonceAlice, \funGen{\varNonceAlice})} \\
    \procZkf{\cnstRelation_2}{(\funStar{\varSpendableCoinAlice}.\varCoin), (\funStar{\varSpendableCoinAlice}.\varBlindingFactor, \funStar{\varSpendableCoinAlice}.\varValue)} \\
    ...
    \< \< \procZkf{\cnstRelation_2}{(\funStar{\varSpendableCoinBob}.\varCoin), (\funStar{\varSpendableCoinBob}.\varBlindingFactor, \funStar{\varSpendableCoinBob}.\varValue)} \\
