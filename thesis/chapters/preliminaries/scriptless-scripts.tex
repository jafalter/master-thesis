...
The most prominent Scriptless Script is the Adaptor Signature which has been fully formalized and proven to be secure for Schnorr and ECDSA by Aumayr et al. in~\cite{aumayr2020bitcoinchannels}
...
In~\cref{ch:fixedwitnesssignatures} we will leverage the Adaptor Signature concept together with a Two-Party Signature Scheme to build a scriptless Atomic Swap protocol applicable for Mimblewimble-based Cryptocurrencies.
...
\begin{definition}[Adaptor Signature Scheme]
