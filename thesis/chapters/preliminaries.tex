...
\begin{definition}[EUF-NZO]
    \begin{center}
        \fbox{
        \begin{varwidth}{\textwidth}
            \procedure[linenumbering]{$\procEUFNZO{\varN}$} {
            \varPublicParam \opFunResult \procSetupCom{\varSecParam} \\
            \varSet \opFunResult \cnstEmptySet \\
            \cnstSumOneToN (\varValue_i, \varBlindingFactor_i) \sample \cnstIntegersPrimeWithoutZero{*} \\
            \cnstSumOneToN \varCommitment_i \opFunResult \procCommit{\varValue_i}{\varBlindingFactor_i} \\
            \varPubKey \opFunResult \cnstSumOneToN \opAddPoint \varCommitment_i \\
            (\varMsg, \varSignature) \opFunResult \cnstAdversary(\varPublicParam) \\
            \pcreturn \varMsg \opNotIn \varSet \opAnd \procVerf{\varSignature}{\varMsg}{\varPubKey}
            }
