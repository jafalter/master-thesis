...
\begin{definition}{Hard Relation}\label{def:hardRelation}
    Given a language $\varLanguage \opEq \funList{\varBigA \opForWhich \exists\varSmallA \text{s.t.} (\varBigA, \varSmallA) \opIn \cnstRelation}$ then the relation $\cnstRelation$ is
...
\begin{definition}{Commitment}\label{def:commitment}
    TODO
\end{definition}
